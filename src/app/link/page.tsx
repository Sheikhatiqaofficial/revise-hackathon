...
//           <h1 className="w-full text-[#2A254B] text-[36px] font-normal leading-[44.28px] text-center md:text-left opacity-1">
//             The Dandy Chair
//           </h1>
//           <div className="w-full text-[#2A254B] text-[24px] font-normal leading-[32.4px] text-center md:text-left opacity-1">
//             £250
//           </div>
//         </div>
...
//           <div className="flex flex-wrap justify-between gap-[20px] opacity-1 mt-[25px]">
//             <div className="w-[44%] md:w-[44px] h-[51px]">
//               <p className="w-[43px] h-[17px] font-clash-display text-[14px] text-[#2A254B]">Height</p>
